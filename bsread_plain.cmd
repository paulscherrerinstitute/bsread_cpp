...
require bsread
dbLoadRecords "bsread.template", "SCAN=$(SCAN=Event),P=$(SYS=$(IOC))-BSREAD$(BSREAD_PORT=9999),BSREAD_PORT=$(BSREAD_PORT=9999),EVENT_NAME=$(EVENT_NAME=bsread$(BSREAD_PORT=9999)),PULSEID_OFFSET=$(PULSEID_OFFSET=0),BSREAD_PULSEID=$(BSREAD_PULSEID),BSREAD_TS_SEC=$(BSREAD_TS_SEC),BSREAD_TS_NSEC=$(BSREAD_TS_NSEC),READ_FLNK=$(READ_FLNK=)"
